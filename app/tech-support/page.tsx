  ...
  const supportFeatures = [
    {
      ...
      description:
        "Quick response times and dedicated assistance for all your technical needs",
    ...
    },
    {
      ...
      description:
        "Continuous improvements to keep your systems running at peak performance",
      color: "bg-primary/10 text-primary",
    },
    {
      icon: Zap,
      ...
      <section className="py-12 md:py-16 px-4 md:px-16">
        <div className="container">
          <div className="max-w-3xl mx-auto">
            ...
            >
              We provide ongoing support and maintenance for all our automation
              systems. From bug fixes to performance upgrades, we&apos;re here
              to ensure your tools stay efficient and reliable.
            </motion.p>
