            ...
            <div className="container max-w-7xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                    ...
                    >
                        ...
                        >
                            We build AI-powered systems that eliminate
                            repetitive tasks, streamline operations, and help
                            businesses from real estate to restaurants scale
                                ...
                                <div className="relative p-6 h-full flex flex-col">
                                    ...
                                    <div className="space-y-2 md:space-y-4 flex-1">
                                        ...
                                        <div className="bg-primary/10 p-2 md:p-3 rounded-lg max-w-[80%] ml-auto">
                                            <p className="text-[9px] sm:text-sm">
                                                We need to reduce response time
                                                and handle more inquiries.
                                            </p>
                                        </div>

                                        <div className="bg-background/50 p-2 md:p-3 rounded-lg max-w-[80%]">
                                            <p className="text-[9px] sm:text-sm">
                                                I&apos;ll create an automated
                                                response system with smart
